...
const netCoreDeveloper = () => {
    useSEO({
        title: ".NET Core Developer | The Digital Connect",
        description: "Hire experienced .NET Core developers to build scalable, secure and high-performance applications."
    });
