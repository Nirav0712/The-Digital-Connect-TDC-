...
const WordpressDeveloper = () => {
    useSEO({
        title: "WordPress Developer | The Digital Connect",
        description: "Hire experienced WordPress developers to build scalable, secure and high-performance applications."
    });
