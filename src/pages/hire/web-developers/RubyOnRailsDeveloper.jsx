...
const RubyOnRailsDeveloper = () => {
    useSEO({
        title: "Ruby on Rails Developer | The Digital Connect",
        description: "Hire experienced Ruby on Rails developers to build scalable, secure and high-performance applications."
    });
