...
const SalesforceCommerceCloudDeveloper = () => {
    useSEO({
        title: "Salesforce Commerce Cloud Developer | The Digital Connect",
        description: "Hire experienced Commerce Cloud developers to build scalable, secure and high-performance applications."
    });
