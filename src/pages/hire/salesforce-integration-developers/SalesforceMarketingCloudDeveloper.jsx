...
const SalesforceMarketingCloudDeveloper = () => {
    useSEO({
        title: "Salesforce Marketing Cloud Developer | The Digital Connect",
        description: "Hire experienced Marketing Cloud developers to build scalable, secure and high-performance applications."
    });
