...
const SalesforceConsultant = () => {
    useSEO({
        title: "Salesforce Consultant | The Digital Connect",
        description: "Hire experienced Salesforce Strategy developers to build scalable, secure and high-performance applications."
    });
