...
const MotionDesigner = () => {
    useSEO({
        title: "Motion Designer | The Digital Connect",
        description: "Hire experienced Motion Design developers to build scalable, secure and high-performance applications."
    });
