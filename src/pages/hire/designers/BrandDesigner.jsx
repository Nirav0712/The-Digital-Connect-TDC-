...
const BrandDesigner = () => {
    useSEO({
        title: "Brand Designer | The Digital Connect",
        description: "Hire experienced Brand Design developers to build scalable, secure and high-performance applications."
    });
