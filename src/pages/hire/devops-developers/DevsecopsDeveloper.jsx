...
const DevsecopsDeveloper = () => {
    useSEO({
        title: "DevSecOps Developer | The Digital Connect",
        description: "Hire experienced DevSecOps developers to build scalable, secure and high-performance applications."
    });
