...
const KubernetesDeveloper = () => {
    useSEO({
        title: "Kubernetes Developer | The Digital Connect",
        description: "Hire experienced Kubernetes developers to build scalable, secure and high-performance applications."
    });
