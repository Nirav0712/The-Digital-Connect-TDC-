...
const DesignSystems = () => {
    useSEO({ title: "Design Systems Services | The Digital Connect", description: "Scalable React-ready tokenized component libraries ensuring infinite consistency for engineering teams." });
    const theme = { accent: "text-emerald-500", bg: "bg-emerald-400", softBg: "bg-emerald-50" };

    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="UI/UX Design" parentRoute="/services/ui-ux-design" eyebrow="Design Systems" title="Consistency at Every Digital Touchpoint." description="Scalable React-ready tokenized component libraries ensuring infinite consistency for engineering teams." theme={theme} />
