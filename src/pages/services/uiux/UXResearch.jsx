...
const UXResearch = () => {
    useSEO({ title: "UX Research Services | The Digital Connect", description: "Deep qualitative and quantitative behavioral research powering human-centered product development." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="UI/UX Design" parentRoute="/services/ui-ux-design" eyebrow="UX Research" title="Understand People Before Designing for Them." description="Deep qualitative and quantitative behavioral research powering human-centered product development." theme={theme} />
