...
const APIDevelopment = () => {
    useSEO({ title: "API Development Services | The Digital Connect", description: "Bulletproof RESTful and GraphQL backend infrastructures handling incredible concurrency flawlessly." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Software Development" parentRoute="/services/software-development" eyebrow="API Development" title="The Infrastructure Behind Connected Products." description="Bulletproof RESTful and GraphQL backend infrastructures handling incredible concurrency flawlessly." theme={theme} />
