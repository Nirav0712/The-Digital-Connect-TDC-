...
const SaaS = () => {
    useSEO({ title: "SaaS Services | The Digital Connect", description: "Multi-tenant cloud architectures constructed natively for massive subscription billing scaling." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Software Development" parentRoute="/services/software-development" eyebrow="SaaS" title="SaaS Products Built to Scale." description="Multi-tenant cloud architectures constructed natively for massive subscription billing scaling." theme={theme} />
