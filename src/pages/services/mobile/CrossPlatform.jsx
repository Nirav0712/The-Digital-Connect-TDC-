...
const CrossPlatform = () => {
    useSEO({ title: "Cross-Platform Apps Services | The Digital Connect", description: "Omnichannel development frameworks unifying Web, iOS, and Android tightly from a singular repository." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Mobile App Development" parentRoute="/services/mobile-app-development" eyebrow="Cross-Platform Apps" title="One Product. Multiple Platforms." description="Omnichannel development frameworks unifying Web, iOS, and Android tightly from a singular repository." theme={theme} />
