...
const FlutterDevelopment = () => {
    useSEO({ title: "Flutter Services | The Digital Connect", description: "Google-backed dart infrastructures painting lightning fast canvases universally without compromise." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Mobile App Development" parentRoute="/services/mobile-app-development" eyebrow="Flutter" title="60fps Graphics Anywhere." description="Google-backed dart infrastructures painting lightning fast canvases universally without compromise." theme={theme} />
