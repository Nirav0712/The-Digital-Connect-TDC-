...
const PPC = () => {
    useSEO({ title: "PPC Services | The Digital Connect", description: "Viciously optimized Google and Meta media buys protecting Return On Ad Spend at all costs natively." });
    const theme = { accent: "text-blue-600", bg: "bg-blue-500", softBg: "bg-blue-50" };

    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Digital Marketing" parentRoute="/services/digital-marketing" eyebrow="PPC" title="Turn Paid Clicks Into Measurable Growth." description="Viciously optimized Google and Meta media buys protecting Return On Ad Spend at all costs natively." theme={theme} />
