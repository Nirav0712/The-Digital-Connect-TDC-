...
const PerformanceMarketing = () => {
    useSEO({ title: "Performance Marketing Services | The Digital Connect", description: "Complete funnel attribution from first-touch click all the way down to closed Salesforce revenue tracking." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Digital Marketing" parentRoute="/services/digital-marketing" eyebrow="Performance Marketing" title="Every Campaign Should Have a Number Behind It." description="Complete funnel attribution from first-touch click all the way down to closed Salesforce revenue tracking." theme={theme} />
