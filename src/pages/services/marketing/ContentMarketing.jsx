...
const ContentMarketing = () => {
    useSEO({ title: "Content Marketing Services | The Digital Connect", description: "Editorial velocity combined with intent mapping, generating extreme authority and inbound lead captures." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Digital Marketing" parentRoute="/services/digital-marketing" eyebrow="Content Marketing" title="Content That Earns Attention and Trust." description="Editorial velocity combined with intent mapping, generating extreme authority and inbound lead captures." theme={theme} />
