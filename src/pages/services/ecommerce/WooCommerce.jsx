...
const WooCommerce = () => {
    useSEO({ title: "WooCommerce Services | The Digital Connect", description: "Deeply customized open-source Woo commerce experiences granting complete data ownership and limitless CMS capabilities." });
    ...
    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Ecommerce Development" parentRoute="/services/ecommerce-development" eyebrow="WooCommerce" title="Flexible Ecommerce on WordPress." description="Deeply customized open-source Woo commerce experiences granting complete data ownership and limitless CMS capabilities." theme={theme} />
