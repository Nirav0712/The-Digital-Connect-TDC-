...
const CustomEcommerce = () => {
    useSEO({ title: "Custom Ecommerce Services | The Digital Connect", description: "Next.js and Node.js bespoke storefronts engineered from scratch for massive unique catalog demands." });
    const theme = { accent: "text-orange-500", bg: "bg-orange-400", softBg: "bg-orange-50" };

    return (
        <PageTransition>
            <div className="w-full bg-[#FAF9F7] min-h-screen font-sans overflow-hidden">
                <SubServiceHero parentTitle="Ecommerce Development" parentRoute="/services/ecommerce-development" eyebrow="Custom Ecommerce" title="Ecommerce Without Platform Limitations." description="Next.js and Node.js bespoke storefronts engineered from scratch for massive unique catalog demands." theme={theme} />
